...
<div class="wpnwm-news-grid news-grid wpnwm-medium-<?php echo $grid_clmn; ?> wpnwm-columns <?php echo $thumb_cls; ?>">	
	<div class="wpnwm-news-grid-inr wpnwm-clearfix">
...
<div class="wpnwm-news-grid news-grid wpnwm-medium-<?php echo $grid_clmn; ?> wpnwm-columns noimage">
	<div class="news-grid-content">	
