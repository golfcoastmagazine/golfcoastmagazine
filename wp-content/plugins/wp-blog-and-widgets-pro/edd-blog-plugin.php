...
function edd_blog_license_menu() {
	add_plugins_page( 'Blog Plugin License', 'Blog Plugin License', 'manage_options', 'blogpro-license', 'edd_blog_license_page' );
}
add_action('admin_menu', 'edd_blog_license_menu');
			...
			<table class="form-table">
				<tbody>
					<tr valign="top">
						...
						<td>
							<input id="edd_blog_license_key" name="edd_blog_license_key" type="text" class="regular-text" value="<?php esc_attr_e( $license ); ?>" />
							<label class="description" for="edd_blog_license_key"><?php _e('Enter your license key'); ?></label>
						</td>
					</tr>
...
function edd_blog_check_license() {
	...
	$api_params = array(
		...
		'license' => $license,
		'item_name' => urlencode( EDD_BLOG_ITEM_NAME ),
		'url'       => home_url()
	);
