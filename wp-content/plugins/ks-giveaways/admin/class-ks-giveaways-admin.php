...
class KS_Giveaways_Admin
{
    ...
    public function input_test_services_subscription()
    {
        ...
        echo '<button class="button" id="ks-giveaways-test-services-subscription-button">Add Subscriber</button>';
    ...
    public function ajax_test_services_subscription()
    {
        ...
        $r = $ks_giveaways->sync_provider_email_address($email, true);
...
EOF;
    ...
    public function add_meta_boxes($post_type)
    {
        ...
        {
            add_meta_box('ks_contest_services', __('Step 5 &mdash; Services'), array($this, 'services_meta_box'), KS_GIVEAWAYS_POST_TYPE, 'normal', 'default', array(
