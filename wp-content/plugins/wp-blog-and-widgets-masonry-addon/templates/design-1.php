		...
		<div class="blog-grid-content <?php echo $sharing_cls; ?>">
			...
			<div class="blog-image-bg">
				<a href="<?php echo $post_link; ?>" target="<?php echo $link_target; ?>">
					<img src="<?php echo $post_featured_image; ?>" alt="<?php _e('Post Image', 'wp-blog-and-widgets'); ?>" />
				</a>
			</div>
			<?php } ?>
			...
			if($showContent == "true") { ?>
				<div class="blog-content">
					...
					<?php if($showreadmore == 'true') { ?>
						<a href="<?php echo $post_link; ?>" target="<?php echo $link_target; ?>" class="readmorebtn"><?php esc_html_e('Read More', 'wp-blog-and-widgets'); ?></a>
					<?php } ?>
