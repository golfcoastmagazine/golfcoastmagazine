...
function wpbawm_plugin_license_menu() {
	add_plugins_page( 'WP Blog and Widget - Masonry License', 'Blog - Masonry Plugin License', 'manage_options', 'wpbawm-license', 'wpbawm_plugin_license_page' );
}
add_action('admin_menu', 'wpbawm_plugin_license_menu');
			...
			<table class="form-table">
				<tbody>
					<tr valign="top">
						...
						<td>
							<input id="edd_wpbawm_license_key" name="edd_wpbawm_license_key" type="text" class="regular-text" value="<?php esc_attr_e( $license ); ?>" />
							<label class="description" for="edd_wpbawm_license_key"><?php _e('Enter your license key'); ?></label>
						</td>
					</tr>
...
function edd_wpbawm_check_license() {
	...
	$api_params = array(
		...
		'license' => $license,
		'item_name' => urlencode( EDD_WPBAWM_ITEM_NAME ),
		'url'       => home_url()
	);
