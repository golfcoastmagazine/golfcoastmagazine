 ...
 */
class GAPGoogle_Cache_Memcache extends GAPGoogle_Cache_Abstract
{
  ...
  /**
   * @var GAPGoogle_Client the current client
   */
  private $client;
  ...
  public function __construct(GAPGoogle_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new GAPGoogle_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws GAPGoogle_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new GAPGoogle_Cache_Exception("Couldn't store data in cache");	 	 			  	 	   		  
    }
