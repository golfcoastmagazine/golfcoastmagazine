...
<div class="wpspwpost-slides">  
		...
		<?php if(0 == $newscount % 2 ) { ?>
			...
			<div class="wpspwpost-image-bg withimage">
		...
		<?php } else { ?>
			<div class="wpspwpost-short-content withoutimgblue">
			<?php if($showCategory == "true") { ?>
				<div class="wpspwpost-categories">	
							<?php echo $cate_name; ?>			
			...
			<div class="wpspwpost-date">		
				<?php  if($showAuthor == 'true') { ?> <span><?php  esc_html_e( 'By ', 'wpspw-post-and-widgets' ) .the_author(); ?></span><?php } ?>
				<?php echo ($showAuthor == 'true' && $showDate == 'true') ? '&nbsp;/&nbsp;' : '' ?>
				<?php if($showDate == "true") { echo get_the_date(); } ?>
				</div>
				<?php } ?>
