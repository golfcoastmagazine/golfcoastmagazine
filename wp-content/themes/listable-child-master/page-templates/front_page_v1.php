            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-9">
                    ...
                    <div class="row blog-widget-container">
                        ...
                        echo do_shortcode( '[ajax_load_more post_type="post" offset="6" posts_per_page="6" pause="true" scroll="false" transition="fade" images_loaded="true" button_label="load more stories" button_loading_label="loading stories..."]' );
                        ?>
                ...
                <div class="col-md-4 col-sm-3">
                    ...
                    <div class="featured-video">
                        ...
                        <?php
                            ...
                            echo get_post_meta(14306,'gm_embedded_code', true);
                        ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="recent-story-thumbnail">
                                                <?php the_post_thumbnail('story-featured'); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            ...
                                            <div class="recent-story-excerpt">
                                                <p><?php the_excerpt_max_charlength(50);?> <a href="<?php echo get_post_permalink(); ?>" class="read-more">read more <i class="fa fa-long-arrow-right"></i></a></p>
